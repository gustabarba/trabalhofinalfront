        ...
        <div class="cliente card col-12">
            <div class="row g-0">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-xl-3 card-body col-12">
                    <h5 class="card-title">
                        <b> ${cliente.name.first} ${cliente.name.last} </b>
                    </h5>
                    <p class="card-text">
                        <b>Idade:</b> ${cliente.dob.age}<br />
                        <b>Gênero:</b> ${
                            cliente.gender == "female"
                                ? "feminino"
                                : "masculino"
                        }<br />
                ...
                <div class="card-img-bottom col-12">
                    <div style="width: 100%">
                        <iframe
                            ...
                            marginheight="0"
                            marginwidth="0"
                            style="border-radius: 5px; background-color: #ddd"
                            src="https://maps.google.com/maps?width=100%25&amp;height=300&amp;hl=en&amp;q=${enderecoSemRua}&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                        ></iframe>
                    </div>
                </div>
            </div>
