...
function imprimirClientes(resultado) {
    ...
    resultado.results.forEach((cliente) => {
        let hashCliente = encodeURI(
            CryptoJS.AES.encrypt(JSON.stringify(cliente), "1234").toString()
        );
        impressao += `
                ...
                <div class="row g-0">
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-xl-9">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <a
                                    href="./cliente.html?u=${hashCliente}"
                                    class="tema-base btn btn-primary btn-sm"
                                    tabindex="-1"
                                    role="button"
                                    >Ver cliente
                                </a>
